#DROP DATABASE IF EXISTS reduced_social_med;
CREATE DATABASE IF NOT EXISTS reduced_social_med;
USE reduced_social_med;
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/med/people_reduced.csv'
INTO TABLE people 
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/med/groups_reduced.csv'
INTO TABLE groups 
FIELDS TERMINATED BY ',' 
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/med/posts_reduced.csv'
INTO TABLE posts 
FIELDS TERMINATED BY ',' 
IGNORE 1 LINES;
