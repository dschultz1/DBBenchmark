#DROP DATABASE IF EXISTS reduced_social_small;
CREATE DATABASE IF NOT EXISTS reduced_social_small;
USE reduced_social_small;
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/small/people_reduced.csv'
INTO TABLE people 
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/small/groups_reduced.csv'
INTO TABLE groups 
FIELDS TERMINATED BY ',' 
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE 'C:/Users/zaharacw/Documents/DBProject/DBBenchmark/SocialNetworkData/small/posts_reduced.csv'
INTO TABLE posts 
FIELDS TERMINATED BY ',' 
IGNORE 1 LINES;
